...
const REQUIREMENTS = [
  ...
  },
  {
    ...
    desc: "Current registration card or vehicle title proving ownership of the impounded vehicle.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
  ...
  {
    title: "Payment",
    desc: "Cash, credit card, or debit card for applicable impound and storage fees.",
    icon: (
      <svg className="w-6 h-6" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
...
const STEPS = [
  {
    step: "1",
    title: "Contact Us",
    desc: "Call us or use the form below with your vehicle information. We\u2019ll confirm if your vehicle is in our system.",
  },
  {
    step: "2",
    title: "Gather Documents",
    desc: "Bring your valid photo ID, vehicle registration or title, and payment method to our impound yard.",
  },
  {
    step: "3",
    title: "Visit Our Yard",
    desc: "Come to either our Apache Junction or Phoenix location during office hours to complete the redemption process.",
  },
  {
    step: "4",
    title: "Drive Away",
    desc: "Once documentation is verified and fees are paid, you\u2019ll be reunited with your vehicle and on your way.",
  },
];

export default function LocateVehicleContent() {
    ...
    <>
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-600">
                      {COMPANY.hours.weekday} &bull; {COMPANY.hours.saturday} &bull; {COMPANY.hours.sunday}
                    </span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg className="w-5 h-5 text-primary shrink-0" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 reveal">
            <h2 className="text-3xl md:text-4xl font-bold text-blue-900 mb-4 font-heading">
              Vehicle Redemption Requirements
            </h2>
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              To retrieve your vehicle, please bring the following items to our
              impound yard.
            </p>
          </div>
          ...
          <div className="reveal glass-card-white rounded-2xl p-8 md:p-10 shadow-md">
            ...
            <div className="space-y-4 text-gray-600 leading-relaxed">
              <div className="flex gap-3 items-start">
                ...
                <p>
                  <strong className="text-blue-900">Personal belongings:</strong> You may retrieve personal items from your vehicle during business hours with valid ID at no charge, even before paying impound fees.
                </p>
              </div>
              <div className="flex gap-3 items-start">
                <div className="w-6 h-6 rounded-full bg-blue-50 text-primary flex items-center justify-center shrink-0 mt-0.5">
                ...
                <p>
                  <strong className="text-blue-900">Third-party pickup:</strong> If someone is picking up the vehicle on your behalf, they must bring a notarized authorization letter along with both their ID and a copy of the registered owner&rsquo;s ID.
                </p>
              </div>
              <div className="flex gap-3 items-start">
                <div className="w-6 h-6 rounded-full bg-blue-50 text-primary flex items-center justify-center shrink-0 mt-0.5">
                ...
                <p>
                  <strong className="text-blue-900">Storage fees:</strong> Daily storage fees accrue per Arizona state regulations. Retrieving your vehicle as soon as possible will minimize total costs.
                </p>
              </div>
              <div className="flex gap-3 items-start">
                <div className="w-6 h-6 rounded-full bg-blue-50 text-primary flex items-center justify-center shrink-0 mt-0.5">
                ...
                <p>
                  <strong className="text-blue-900">Payment methods:</strong> We accept cash, Visa, Mastercard, American Express, and debit cards. No personal checks.
                </p>
              </div>
              <div className="flex gap-3 items-start">
                <div className="w-6 h-6 rounded-full bg-blue-50 text-primary flex items-center justify-center shrink-0 mt-0.5">
                ...
                <p>
                  <strong className="text-blue-900">Disputes:</strong> If you believe your vehicle was towed in error, please contact us with your details. All tows are documented with photographs and timestamps.
                </p>
              </div>
            </div>
          </div>
