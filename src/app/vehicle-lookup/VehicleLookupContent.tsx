              ...
              <div className="glass-form rounded-2xl p-8 md:p-10 shadow-lg">
                ...
                <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-blue-900">Online vehicle lookup coming soon</p>
                      <p className="text-xs text-gray-600 mt-1">
                        We are integrating with TowBook to allow online VIN and license plate searches.
                        In the meantime, call us for immediate assistance.
                      </p>
                    </div>
                  </div>
                </div>
