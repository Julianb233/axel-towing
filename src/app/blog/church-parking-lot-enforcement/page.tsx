                ...
                <div className="glass-card-white rounded-2xl p-6 mt-12 reveal">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-gray-500 text-sm">Professional private property towing and parking enforcement serving the Greater Phoenix metro area since 2021. Trusted by churches, schools, and community organizations across Arizona.</p>
                    </div>
                  </div>
                </div>
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                ...
                <div className="glass-card-white rounded-2xl p-6 text-center border-glow-blue reveal">
                  ...
                  <p className="text-gray-500 text-sm mb-4">Talk to our parking enforcement team today.</p>
