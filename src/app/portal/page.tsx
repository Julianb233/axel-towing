  ...
  return (
    <>
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 reveal">
            <span className="text-primary font-semibold text-sm uppercase tracking-wider font-heading">Coming Soon</span>
            ...
            <p className="text-gray-600 text-lg max-w-2xl mx-auto">
              Advanced features rolling out to give you even more control over your parking enforcement program.
            </p>
          </div>
            ...
            {[
              {
                ...
                desc: "Instant alerts when a vehicle is towed, released, or a patrol is completed on your property.",
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Complete searchable history of every vehicle towed from your property with full documentation.",
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "View and customize your patrol schedule. Request additional patrols for events or busy periods.",
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
              ...
              },
              {
                ...
                desc: "Browse timestamped, geo-tagged photos for every tow with full legal evidence chain.",
                icon: (
                  <svg className="w-7 h-7" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" d="M6.827 6.175A2.31 2.31 0 015.186 7.23c-.38.054-.757.112-1.134.175C2.999 7.58 2.25 8.507 2.25 9.574V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18V9.574c0-1.067-.75-1.994-1.802-2.169a47.865 47.865 0 00-1.134-.175 2.31 2.31 0 01-1.64-1.055l-.822-1.316a2.192 2.192 0 00-1.736-1.039 48.774 48.774 0 00-5.232 0 2.192 2.192 0 00-1.736 1.039l-.821 1.316z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 12.75a4.5 4.5 0 11-9 0 4.5 4.5 0 019 0zM18.75 10.5h.008v.008h-.008V10.5z" />
              ...
              <div
                key={feature.title}
                className={`reveal glass-card rounded-2xl p-7 text-center delay-${((i % 4) + 1) * 100}`}
              >
                <div className="w-14 h-14 mx-auto bg-blue-50 text-primary rounded-2xl flex items-center justify-center mb-5 border-glow-blue">
                  {feature.icon}
                </div>
                <h3 className="text-lg font-bold text-blue-900 mb-2 font-heading">
                  {feature.title}
