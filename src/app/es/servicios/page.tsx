...
export const metadata: Metadata = {
  ...
  description:
    "Axle Towing & Impound ofrece remolque de propiedad privada, control de estacionamiento, remolque HOA, apartamentos y propiedad comercial en Phoenix -- gratis para propietarios. Servicio de reubicacion de vehiculos tambien disponible.",
  alternates: {
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 w-full">
          ...
          <p className="text-lg md:text-xl text-white/90 max-w-2xl leading-relaxed reveal delay-200">
            Desde remolque de propiedad privada hasta control de estacionamiento, {COMPANY.name} ofrece soluciones integrales para todo tipo de propiedad. La mayoria de los servicios son completamente gratis para propietarios.
          </p>
        </div>
      </section>
