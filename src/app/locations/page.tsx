...
export const metadata: Metadata = {
  ...
  description:
    "Axle Towing provides private property towing and parking enforcement across 30 cities in the Greater Phoenix area. Find your city for local service details.",
};
      ...
      <section className="relative min-h-[50vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 w-full text-center">
          ...
          <p className="text-lg md:text-xl text-white/95 max-w-2xl mx-auto">
            ...
            30 cities. Find your local service area below.
          </p>
        </div>
      </section>
