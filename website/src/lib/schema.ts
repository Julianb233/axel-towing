...
export function towingServiceSchema() {
  return {
    ...
    url: BASE_URL,
    description:
      "Professional private property towing, parking enforcement, abandoned vehicle removal, and paid vehicle relocation services for property managers in the Phoenix metro area. Towing dispatch is available 24/7; vehicle release and office visits follow posted hours or arrangement.",
    telephone: COMPANY.phone,
    email: COMPANY.email,
    image: COMPANY.logo,
    logo: COMPANY.logo,
    ...
    openingHoursSpecification: {
      ...
      opens: "00:00",
      closes: "23:59",
      description: "24/7 towing dispatch available; vehicle release and office visits follow posted hours or arrangement",
    },
    hasOfferCatalog: {
      "@type": "OfferCatalog",
      ...
      itemListElement: [
        ...
        },
        {
          ...
          itemOffered: {
            "@type": "Service",
            name: "Abandoned Vehicle Removal",
            description:
              "Abandoned vehicle removal for apartments, HOAs, commercial properties, and private lots.",
          },
        },
      ],
    },
    knowsAbout: [
      ...
      "documented parking enforcement setup",
      "property towing signage coordination",
