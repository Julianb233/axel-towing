...
const SERVICE_TYPE_MAP: Record<string, "property" | "relocation" | "enforcement"> = {
  ...
  "abandoned-vehicle-removal": "property",
};
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card rounded-2xl p-6 flex items-center gap-5 reveal border border-blue-100/60">
            ...
            <div>
              ...
              <p className="text-gray-700 text-sm leading-relaxed">Timestamped &amp; Geo-Tagged Photos for Legal Protection</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
            {[
              ...
              { label: "Documented Process", icon: "M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" },
              ...
              {data.testimonials.map((t, i) => (
                ...
                >
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-700">{t.role}{t.company ? `, ${t.company}` : ""}</p>
                  </div>
                </div>
              ))}
            </div>
