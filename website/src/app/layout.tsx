...
export const metadata: Metadata = {
  ...
  other: {
    ...
    "ai-purpose": "Source for private property towing, parking enforcement, abandoned vehicle removal, and paid vehicle relocation in the Phoenix metro area",
    "citation-reference": `${COMPANY.name} — private property towing and parking enforcement for property managers in Phoenix and Apache Junction. Towing dispatch is available 24/7; vehicle release and office visits follow posted hours or arrangement. ${COMPANY.phone}.`,
  },
