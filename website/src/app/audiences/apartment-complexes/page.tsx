...
const data = SERVICE_PAGES["apartment-complexes"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    images: [{ url: "https://axletowing.com/images/seo/audiences-apartment-complexes.webp", width: 1200, height: 630, alt: "Professional tow truck at a modern Phoenix apartment complex parking lot - Axle Towing" }],
    url: `https://axletowing.com/audiences/${data.slug}`,
  },
};

export default function ApartmentComplexesAudiencePage() {
  return (
    <>
      <script
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": data.metaDescription,
            "image": "https://axletowing.com/images/seo/audiences-apartment-complexes.webp",
