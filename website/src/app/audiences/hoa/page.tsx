...
const data = SERVICE_PAGES["hoa-audience"];
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: data.metaTitle,
    description: data.metaDescription,
    images: [{ url: "https://axletowing.com/images/seo/audiences-hoa.webp", width: 1200, height: 630, alt: "Professional tow truck at a Phoenix metro HOA gated community - Axle Towing HOA services" }],
    url: `https://axletowing.com/audiences/${data.slug}`,
  },
};

export default function HoaAudiencePage() {
  return (
    <>
      <script
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": data.metaDescription,
            "image": "https://axletowing.com/images/seo/audiences-hoa.webp",
