...
const COMPARISON_ROWS = [
  ...
  { feature: "Coverage Area", axle: "38 cities, 2 yards", industry: "1–3 cities", axleWins: true },
...
const DIFFERENTIATORS = [
  ...
  },
  {
    ...
    desc: "With 6+ trucks across 2 yards and 38 cities, we guarantee sub-30-minute response times. Industry average is 45–90 minutes — if they show up at all.",
    icon: (
      <svg className="w-8 h-8" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
