          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="reveal">
              <div className="glass-form rounded-2xl p-8 md:p-10 shadow-lg">
                ...
                {/* Online vehicle lookup via TowBook */}
                <div className="mt-8 p-4 bg-blue-50 rounded-xl border border-blue-100">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <p className="text-sm font-medium text-blue-900">Online Vehicle Lookup Available</p>
                      <p className="text-xs text-gray-600 mt-1 mb-3">
                        Search by license plate number to check if your vehicle is in our system.
                      </p>
                      <a
