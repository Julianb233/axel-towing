...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "5 Signs Your Apartment Complex Needs Professional Parking Enforcement",
    description: "Discover the top warning signs that your apartment complex needs professional parking enforcement. Learn how free towing partnerships solve parking problems for Phoenix-area property managers.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/5-signs-apartment-needs-parking-enforcement",
  };
  return (
    <>
