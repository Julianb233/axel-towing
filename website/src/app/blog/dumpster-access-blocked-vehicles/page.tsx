...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Blocked Dumpster Access: When Parking Violations Affect Waste Management",
    description: "Learn how vehicles blocking dumpster access create health, safety, and financial problems for Arizona properties. Solutions for keeping waste areas clear.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/dumpster-access-blocked-vehicles",
  };
  return (
    <>
