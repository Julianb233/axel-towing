...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "The Complete Guide to Apartment Complex Parking Management in Phoenix",
    description: "Learn how to manage apartment complex parking in Phoenix. Covers tenant parking assignments, unauthorized vehicle removal, ARS 28-3511 compliance, and free enforcement programs for property owners.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/apartment-complex-parking-management-guide",
  };
  return (
    <>
