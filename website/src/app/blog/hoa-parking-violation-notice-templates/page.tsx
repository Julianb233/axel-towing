...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "HOA Parking Violation Notices: Templates and Best Practices",
    description: "Download free HOA parking violation notice templates for Arizona communities. Includes courtesy notices, formal warnings, final notices, and towing authorization letters with best practices for each.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/hoa-parking-violation-notice-templates",
  };
  return (
    <>
