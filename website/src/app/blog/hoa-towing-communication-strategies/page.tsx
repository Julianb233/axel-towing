...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "How to Communicate Towing Policies Without Alienating Homeowners",
    description: "Master the art of communicating towing policies in your HOA community. Learn proven strategies for announcing new rules, handling pushback, framing enforcement positively, and building community support.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/hoa-towing-communication-strategies",
  };
  return (
    <>
