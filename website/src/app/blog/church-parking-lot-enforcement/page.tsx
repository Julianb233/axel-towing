...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Church and Religious Facility Parking Enforcement: Balancing Grace and Order",
    description: "How Phoenix churches and religious facilities can manage parking during services and events. Covers community-friendly enforcement, signage requirements, and free towing programs.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/church-parking-lot-enforcement",
  };
  return (
    <>
