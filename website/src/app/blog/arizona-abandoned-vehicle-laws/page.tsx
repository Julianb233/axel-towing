...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Arizona Abandoned Vehicle Laws: Timelines, Procedures, and Your Rights",
    description: "Complete guide to Arizona abandoned vehicle laws under ARS 28-4141 through 28-4145. Learn the legal timelines, notification requirements, lien procedures, and property owner rights for abandoned vehicles in Phoenix.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/arizona-abandoned-vehicle-laws",
  };
  return (
    <>
