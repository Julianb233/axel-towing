...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Parking Lot Lighting and Safety: Best Practices for Arizona Properties",
    description: "Best practices for parking lot lighting and safety in Arizona. Learn about security lighting standards, crime deterrence, and maintaining safe parking environments.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/parking-lot-lighting-safety-arizona",
  };
  return (
    <>
