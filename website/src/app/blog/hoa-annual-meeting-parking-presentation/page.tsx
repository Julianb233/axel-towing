...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "How to Present Parking Enforcement Results at Your HOA Annual Meeting",
    description: "Learn how to prepare and deliver an effective parking enforcement presentation at your HOA annual meeting. Includes data to track, slide templates, and tips for handling homeowner Q&A.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/hoa-annual-meeting-parking-presentation",
  };
  return (
    <>
