...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Medical Facility Parking Enforcement: Ensuring Patient Access Comes First",
    description: "How Phoenix medical facilities can protect patient parking from unauthorized use. Covers ADA compliance, emergency access, enforcement strategies, and free towing programs for healthcare providers.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/medical-facility-parking-enforcement",
  };
  return (
    <>
