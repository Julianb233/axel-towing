...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Arizona Vehicle Lien Laws for Towing Companies: A Legal Overview",
    description: "Understand Arizona vehicle lien laws for towing companies under ARS 28-4141 through 28-4145. Learn about mechanic's liens, notification requirements, ADOT procedures, and lien sale processes for unclaimed vehicles.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/arizona-vehicle-lien-laws-towing-companies",
  };
  return (
    <>
