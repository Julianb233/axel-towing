...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "How to Get Illegally Parked Vehicles Removed from Private Property for Free",
    description: "Complete guide for Arizona property owners: how to legally remove unauthorized vehicles from your private property at no cost using a professional towing company like Axle Towing.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/how-to-get-illegally-parked-vehicles-removed",
  };
  return (
    <>
