...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Fire Lane Enforcement: A Property Manager's Legal Obligation",
    description: "Learn about fire lane enforcement requirements for Arizona property managers. Understand your legal obligations under ARS 28-884, liability risks, and how professional towing protects your property.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/fire-lane-enforcement-property-managers",
  };
  return (
    <>
            ...
            <aside className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                ...
                <div className="rounded-2xl p-6 bg-gradient-to-br from-primary to-blue-800 text-white text-center reveal">
                  ...
                  <h3 className="font-bold text-white mb-2">Free Compliance Audit</h3>
