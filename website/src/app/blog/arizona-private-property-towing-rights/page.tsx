...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Your Rights: Arizona Private Property Towing Laws for Property Owners",
    description: "Learn what Arizona law says about private property towing rights. Covers property owner authority, signage requirements, authorized towing agreements, and how to protect yourself legally in Phoenix.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/arizona-private-property-towing-rights",
  };
  return (
    <>
