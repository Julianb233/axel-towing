...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "EV Charging Station Parking Enforcement: New Rules for Arizona HOAs",
    description: "Navigate EV charging station parking enforcement for Arizona HOAs. Learn about Arizona's EV-friendly laws, charging etiquette rules, ICE-ing prevention, and how to update your parking policy for electric vehicles.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/hoa-electric-vehicle-parking-policies",
  };
  return (
    <>
