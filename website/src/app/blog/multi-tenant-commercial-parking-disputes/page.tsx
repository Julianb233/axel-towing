...
export default function ArticlePage() {
  const articleSchema = {
    ...
    "@type": "Article",
    headline: "Resolving Multi-Tenant Commercial Parking Disputes: A Manager's Playbook",
    description: "How Phoenix commercial property managers can resolve parking disputes between tenants. Covers allocation strategies, enforcement programs, lease clauses, and free towing services.",
    ...
    mainEntityOfPage: "https://axletowing.com/blog/multi-tenant-commercial-parking-disputes",
  };
  return (
    <>
