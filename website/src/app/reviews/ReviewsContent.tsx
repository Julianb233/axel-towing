      ...
      <section className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <Link
              href={process.env.NEXT_PUBLIC_GOOGLE_REVIEW_URL ?? "https://www.google.com/maps"}
              target="_blank"
              rel="noopener noreferrer"
              className="glass-card-white rounded-2xl px-8 py-5 flex items-center gap-4 shadow-md hover:shadow-lg transition-shadow"
            >
              ...
              <div>
                <span className="text-lg font-bold text-blue-900 font-heading">Read our Google Reviews</span>
                <p className="text-xs text-gray-700">See what property managers, HOAs, and commercial clients say</p>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                <span className="text-lg font-bold text-blue-900 font-heading">Leave a Review</span>
                <p className="text-xs text-gray-700">Share your experience on Google, Yelp, or Facebook</p>
              </div>
