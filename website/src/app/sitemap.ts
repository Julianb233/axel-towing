...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/reviews/leave-review`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    { url: `${BASE_URL}/review`, lastModified: now, changeFrequency: 'yearly', priority: 0.4 },
    ...
    {
      url: `${BASE_URL}/resources/hoa-enforcement-checklist`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${BASE_URL}/resources/parking-policy-template`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${BASE_URL}/resources/property-manager-guide`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
  ...
  const spanishPages: MetadataRoute.Sitemap = [
    ...
    {
      url: `${BASE_URL}/es/preguntas-frecuentes`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    ...
    {
      url: `${BASE_URL}/es/mi-vehiculo-fue-remolcado`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    ...
    {
      url: `${BASE_URL}/es/cotizacion`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${BASE_URL}/es/ubicar-vehiculo`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${BASE_URL}/es/area-de-servicio`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.6,
    },
    {
      url: `${BASE_URL}/es/ubicaciones`,
      lastModified: now,
      changeFrequency: 'monthly',
      priority: 0.7,
    },
