...
const VEHICLE_OWNER_FAQS = [
  ...
  },
  {
    ...
    a: "Yes. You can retrieve personal belongings from an impounded vehicle during business hours. You\u2019ll need to show valid photo ID. There is no charge to retrieve personal items. Contact us to schedule a time.",
  },
  {
