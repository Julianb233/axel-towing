...
const needs: NeedItem[] = [
  ...
  {
    id: 2,
    title: "Google Business Profile Manager access (BOTH locations)",
    priority: "critical",
    why: "Live audit on May 6 found Apache Junction at 2.8 stars, Phoenix at 3.0 stars, both showing 9 AM-5 PM hours instead of 24/7, both with empty descriptions, no secondary categories, no services list, no Q&A, no posts. Phoenix has the WRONG phone number on it — (623) 401-2537 instead of (480) 288-5526 — so every Maps call to Phoenix is going to a number we can't trace. We have a fix script ready to run the moment we have access.",
    howTo: "Go to business.google.com, sign in with the account that manages your listings (likely axletowing@gmail.com or elliott.axletowing@gmail.com). For EACH location (Apache Junction + Phoenix): click the location, open the menu, Business Profile settings > People and access > Add > enter julian@aiacrobatics.com > role = Manager > Add. Two locations, 60 seconds each.",
    impact: "Within 24 hours of access we fix the wrong Phoenix phone, set both to 24/7 hours, paste optimized descriptions, add 5 secondary categories, add 6 services with descriptions, add appointment URL. Weeks 2-3 we add 25 photos per location, seed 10 Q&A, publish first 3 posts. 90-day target: both ratings at 4.3+, 12-month target: top-3 Phoenix Map Pack for 'private property towing phoenix'. Full plan: docs/GBP-IMPROVEMENT-STRATEGY-2026-05-06.md",
    estimatedTime: "2 minutes (60 seconds per location)",
  },
  {
    id: 22,
    title: "Confirm what (623) 401-2537 actually rings to",
    priority: "critical",
    why: "Your Phoenix Google Business Profile has (623) 401-2537 listed as the primary phone — not your real (480) 288-5526. Every call from Google Maps to your Phoenix location is going to that number. Need to know if it's a typo Google added during automated listing creation, an old answering-service line you forgot about, or worse — a competitor who got their number on your listing. Best test: call (623) 401-2537 from a number Google doesn't recognize and see who picks up.",
    howTo: "Use a personal phone (not the office line) to call (623) 401-2537. If nobody answers, the line is dead — Google added it as a placeholder we'll overwrite the moment we have Manager access. If a real person answers, ask who they are. Either way, text Julian what you find at +1 (619) 509-0699.",
    impact: "Quantifies how many leads we've been losing. If a competitor has been collecting our calls for months, we may have grounds to escalate to Google for fraudulent listing data. Either way, the fix on our side is the same — Manager access lets us overwrite the field.",
    estimatedTime: "1 minute",
  },
  {
    id: 23,
    title: "Send 10-20 dispatch-cam photos for GBP",
    priority: "high",
    why: "Google profiles with 100+ photos get 5x more calls than average. Both your locations show 0 photos in the panel right now. We have your team headshots and brand assets, but Google's AI deprioritizes stock-looking content — we need real on-the-job shots: trucks at properties, signage installs, before/after parking lots, drivers at work.",
    howTo: "iPhone shots are perfect — actually preferred (they auto-geo-tag). Just text 10-20 to Julian over the next week as your drivers run jobs. Different angles, different times of day, different properties. Skip anything with vehicle plates visible (privacy). We'll batch-upload to GBP on a 5-photos-per-week cadence (recency is a ranking signal).",
    impact: "Closes the photo gap that's putting us behind every competitor. Combined with hours/description fixes, photo recency is the #1 ongoing ranking signal Google measures.",
    estimatedTime: "5 minutes spread across the week",
  },
  {
    id: 24,
    title: "Confirm Facebook / Instagram / LinkedIn handles",
    priority: "medium",
    why: "Linking your social accounts on GBP gives Google another 'this is a real, active business' signal AND drives traffic from Maps to your social proof.",
    howTo: "Reply with the exact URLs (or 'we don't have that one yet'). If you want us to spin them up, we have brand assets ready.",
    impact: "Plus visible social CTAs on the GBP panel = more profile-to-engagement conversion.",
    estimatedTime: "1 minute",
  },
  {
    id: 25,
    title: "List 5-10 happy property-manager clients we can ask for a Google review",
    priority: "high",
    why: "Both ratings (2.8 / 3.0) are dragged down by occasional vehicle-owner complaints — which is normal for any tow company, but lethal for B2B trust. The fix is volume of B2B reviews from property managers and HOA boards. We need YOU to nominate the right people because the relationship is yours.",
    howTo: "Reply with name + property + email or phone for 5-10 property managers / HOA board members who you have a good relationship with. We'll send them the direct Google review link via email + text on your behalf, with a one-line ask. We respond to everything they post within 24h.",
    impact: "Targeting 10+ net new B2B reviews in the next 30 days, 30+ in 90 days, 75+ in 12 months. Moves the rating from 2.8/3.0 to 4.3+ within 90 days.",
    estimatedTime: "5 minutes",
  },
  {
    id: 3,
