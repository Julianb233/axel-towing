...
const changelog: ChangelogGroup[] = [
  ...
  },
  {
    ...
    entries: [
      {
        text: "Launched new /audiences hub with 3 audience-specific landing pages: HOA boards & community managers, apartment property managers, commercial property owners — each a complete program walk-through with FAQs and CTAs",
        category: "website",
      },
      {
        text: "Built /services/abandoned-vehicle-removal — Arizona 72-hour ARS-compliant abandoned vehicle pipeline with full schema markup and FAQ block",
        category: "website",
      },
      {
        text: "Launched /resources/property-manager-towing-hub — central hub linking 11 property-manager resources organized by Guides / Templates / Checklists / Statutes",
        category: "content",
      },
      {
        text: "Published 8 new resource articles covering: ADOT abandoned vehicle form guide, 72-hour rule explainer, contract guide, program-launch runbook, ARS 28-3511/28-874 signage requirements, monthly enforcement checklist, HOA board guide, and monthly compliance report template",
        category: "content",
      },
      {
        text: "Published 6 pillar SEO articles: Arizona private property towing guide 2026, how to choose a towing company, parking-enforcement ROI, vetting-questions checklist, 2026 signage law update, private vs public towing in Arizona — roughly 11,300 words total",
        category: "seo",
      },
      {
        text: "Published 26 city-service AI-SEO articles across 13 Phoenix-metro cities and 5 service clusters (HOA, apartment, commercial, private property, parking enforcement) — roughly 60,000 words covering Phoenix, Mesa, Tempe, Scottsdale, Chandler, Gilbert, Glendale, Queen Creek, Apache Junction, plus East/West Valley umbrellas",
        category: "seo",
      },
      {
        text: "Generated geographic-specific photorealistic hero images for every new article via Google Gemini Imagen 4 Ultra — Camelback Mountain, Superstition Mountains, Old Town Scottsdale, etc. — saved as optimized WebP",
        category: "content",
      },
      {
        text: "Added AI SEO enhancements to every new article: TL;DR sections for answer-engine extraction, Key Takeaways callouts, HowTo schema for procedural articles, E-E-A-T author/reviewer Person schema, and a top-level llms.txt for AI crawlers (ChatGPT, Perplexity, Claude, Gemini)",
        category: "seo",
      },
      {
        text: "Extended SERVICE_PAGES schema and ServicePageTemplate to support a new /audiences URL category, with audience-aware breadcrumbs and JSON-LD",
        category: "infrastructure",
      },
      {
        text: "Updated sitemap.xml with 11 new core routes (/audiences, 3 audience pages, abandoned-vehicle service, resource hub, 8 resource articles) and all 32 new blog slugs",
        category: "seo",
      },
    ],
  },
