        ...
        <div className="glass-card p-6 mb-8 bg-red-50 border-red-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-red-700/70 mt-1">The #1 action item is pointing axletowing.com DNS to Railway. Until this happens, Google cannot index any of the 113 pages we&apos;ve built. Every day of delay equals lost ranking opportunity.</p>
            </div>
          </div>
        </div>
      </ScrollReveal>
