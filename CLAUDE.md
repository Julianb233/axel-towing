...
| Dashboard/Portal | Vercel (ai-acrobatics team) | axle-towing-portal.vercel.app *(note: "axle" — public website project is "axel"; see fleet rule `internal-portal-urls.md`)* |
...
Send session report via iMessage to +16195090699 with specific deliverables, URLs, and Linear IDs.
